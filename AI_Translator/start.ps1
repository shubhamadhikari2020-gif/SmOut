...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd C:\Users\BSR\Desktop\SmOut\SmOut\AI_Translator; .\venv\Scripts\Activate.ps1; python -m uvicorn backend.main:app --host 0.0.0.0 --port 8000 --reload"
